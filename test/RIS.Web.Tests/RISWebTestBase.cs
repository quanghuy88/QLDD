...
{
    public abstract class RISWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static RISWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(RISWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<RISDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<RISDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<RISDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<RISDbContext, Task<T>> func)
        {
            T result;
